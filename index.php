      ...
      <div class="container-fluid">
        <div class="row">
          <?php if ($_SESSION['id_jabatan'] == '1'): ?>
            <div class="col-lg-4">
              <div class="card shadow">
                <div class="card-body">
                  <h5><i class="fas fa-fw fa-cog"></i> Position</h5>
                  <h6 class="text-muted">Number of Position: <?= $jml_jabatan; ?></h6>
            ...
            <div class="col-lg-4">
              <div class="card shadow">
                <div class="card-body">
                  ...
                  <h6 class="text-muted">Number of Users: <?= $jml_user; ?></h6>
          ...
          <div class="col-lg-4">
            <div class="card shadow">
              <div class="card-body">
                <h5><i class="fas fa-fw fa-user-tie"></i> Student</h5>
                <h6 class="text-muted">Number of Student: <?= $jml_siswa; ?></h6>
          ...
          <div class="col-lg-4">
            <div class="card shadow">
              <div class="card-body">
                <h5><i class="text-success fas fa-fw fa-caret-up"></i> <i class="text-success fas fa-fw fa-dollar-sign"></i> Cash</h5>
                <h6 class="text-muted">Total Cash: Rp. <?= number_format($jml_uang_kas - $jml_pengeluaran); ?></h6>
          ...
          <div class="col-lg-4">
            <div class="card shadow">
              <div class="card-body">
                <h5><i class="text-danger fas fa-fw fa-caret-down"></i><i class="text-danger fas fa-fw fa-dollar-sign"></i> Cash Outlay</h5>
                <h6 class="text-muted">Total Cash Outlay: Rp. <?= number_format($jml_pengeluaran); ?></h6>
