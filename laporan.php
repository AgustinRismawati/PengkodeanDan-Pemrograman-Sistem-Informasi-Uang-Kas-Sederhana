        ...
        <div class="not-printed row justify-content-center">
        	<div class="col-lg-5 mr-4">
        		...
        		<form method="post">
        			<div class="form-group">
        				<label for="id_bulan_pembayaran">Choose Month</label>
        			...
        			<div class="form-group">
        				<button type="submit" name="btnLaporanPemasukkan" class="btn btn-primary">Income Report</button>
        			</div>
        		</form>
        	</div>
        	<div class="col-lg-5 ml-4">
        		...
        		<form method="post">
        			...
        			<div class="form-group">
        				<button type="submit" name="btnLaporanPengeluaran" class="btn btn-primary">Cash Outlay Report</button>
        			</div>
        		</form>
        	</div>
        </div>
        <?php if (isset($_POST['btnLaporanPemasukkan'])): ?>
        	...
        	<div class="row m-1">
	        	<div class="col-lg m-1">
	        		<h2 class="text-center mb-3 mt-2">Income Report</h2>
	        		<h3 class="text-left mb-3">Monthly Report: <?= ucwords($fetch_sql['nama_bulan']); ?>, Year: <?= $fetch_sql['tahun']; ?>, Weekly Payment: Rp. <?= number_format($fetch_sql['pembayaran_perminggu']); ?></h3>
	        ...
	        <div class="row mx-1 mb-1 mt-0">
    			<div class="col-lg-4">
    				...
    				?>
		    		<div class="p-3 rounded bg-success total">Total Income: Rp. <?= number_format($jml_uang_kas['jml_uang_kas']); ?></div>
    			</div>
    		</div>
        <?php endif ?>
        <?php if (isset($_POST['btnLaporanPengeluaran'])): ?>
        	...
        	<div class="row m-1 mb-0">
	        	<div class="col-lg m-1">
	        		<h2 class="text-center mb-3 mt-2">Cash Outlay Report</h2>
	        		<h3 class="text-left mb-3">Report From Date: <?= $dari_tanggal_date; ?> Until Date: <?= $sampai_tanggal_date; ?></h3>
	        		<div class="table-responsive">
	        			<table class="table table-bordered table-hover">
	        				<thead>
	        					<tr>
	        						...
	        						<th>Cash Outlay</th>
	        						<th>Information</th>
	        						<th>Issue Date of Cash Outlay</th>
	        						<th>Username</th>
	        					</tr>
	        				</thead>
	        				<tbody>
    		...
    		<div class="row mx-1 mb-1 mt-0">
    			<div class="col-lg-4">
		    		<div class="p-3 rounded bg-success total">Total Cash Outlay: Rp. <?= number_format($total_pengeluaran); ?></div>
    			</div>
    		</div>
        <?php endif ?>
      </div>
