  ...
  <style>
	* {
  	...
  	body {
	    ...
	    background-image: url(assets/img/img_properties/uangkasfoto1.jpg);
	}
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-4 mx-5 py-4 px-5 text-dark rounded border border-dark" style="background-color: rgba(180,190,196,.6);">
				<h3 class="text-center">STUDENTS CASH ARRANGEMENT by AWGUSTIN</h3>
				<form method="post">
		...
		<div style="background-color: transparent;" class="container-fluid mt-5">
			<div class="row justify-content-center">
				<div class="col-lg text-center text-white pt-4 pb-2">
					<p>&copy; Copyright 2024. by Agustin Rismawati. All Right Reserved.</p>
				</div>
			</div>
		</div>
	</footer>
