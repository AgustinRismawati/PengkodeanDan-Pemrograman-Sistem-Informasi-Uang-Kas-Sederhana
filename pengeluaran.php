<?php 
  ...
  if (isset($_POST['btnAddPengeluaran'])) {
    if (addPengeluaran($_POST) > 0) {
      setAlert("Cash Outlay has Been Added", "Successfully dded", "Success");
  ...
  if (isset($_POST['btnEditPengeluaran'])) {
    if (editPengeluaran($_POST) > 0) {
      setAlert("Cash Outlay has been Changed", "Successfully Changed", "Success");
      header("Location: pengeluaran.php");
    }
  }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm">
            <h1 class="m-0 text-dark">Cash Outlay</h1>
          </div><!-- /.col -->
          <div class="col-sm text-right">
            <?php if ($_SESSION['id_jabatan'] !== '3'): ?>
              <button class="btn btn-primary" data-toggle="modal" data-target="#tambahPengeluaranModal"><i class="fas fa-fw fa-plus"></i> Add Cash Outlay</button>
              <!-- Modal -->
                  ...
                  <form method="post">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="tambahPengeluaranModalLabel">Add Cash Outlay</h5>
                      ...
                      <div class="modal-body">
                        <div class="form-group">
                          <label for="jumlah_pengeluaran">Amount of Cash Outlay</label>
              ...
              <table class="table table-bordered table-hover table-striped" id="table_id">
                <thead>
                  <tr>
                    ...
                    <th>Username</th>
                    <th>Information</th>
                    <th>Date of Cash Outlay</th>
                    <th>Amount of Cash Outlay</th>
                    <?php if ($_SESSION['id_jabatan'] !== '3'): ?>
                      <th>Settings</th>
                    <?php endif ?>
                  </tr>
                          ...
                          <div class="modal fade text-left" id="editPengeluaranModal<?= $dp['id_pengeluaran']; ?>" tabindex="-1" role="dialog" aria-labelledby="editPengeluaranModalLabel<?= $dp['id_pengeluaran']; ?>" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <form method="post">
                                ...
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="editPengeluaranModalLabel<?= $dp['id_pengeluaran']; ?>">Chage Cash Outlay</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
                                  </div>
                                  <div class="modal-body">
                                    <div class="form-group">
                                      <label for="jumlah_pengeluaran<?= $dp['id_pengeluaran']; ?>">Amount of Cash Outlay</label>
                                    ...
                                    <div class="form-group">
                                      <label for="keterangan<?= $dp['id_pengeluaran']; ?>">Information</label>
