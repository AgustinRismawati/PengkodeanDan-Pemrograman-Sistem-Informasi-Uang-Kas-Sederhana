<?php 
  ...
  if (isset($_POST['btnEditJabatan'])) {
    if (editJabatan($_POST) > 0) {
      setAlert("Position has Been Changed", "Successfully Changed", "Success");
  ...
  if (isset($_POST['btnTambahJabatan'])) {
    if (addJabatan($_POST) > 0) {
      setAlert("Position has Been Added", "Successfully Added", "Success");
      header("Location: jabatan.php");
    }
  }
?>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center mb-2">
          ...
          <div class="col-sm text-right">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahJabatanModal"><i class="fas fa-fw fa-plus"></i> Add Position</button>
            <!-- Modal -->
                ...
                <form method="post">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="tambahJabatanModalLabel">Add Position</h5>
                    ...
                    <div class="modal-body">
                      <div class="form-group">
                        <label for="nama_jabatan">Add Position</label>
                          ...
                          <div class="modal fade" id="editJabatanModal<?= $dj['id_jabatan']; ?>" tabindex="-1" role="dialog" aria-labelledby="editJabatanModalLabel<?= $dj['id_jabatan']; ?>" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <form method="post">
                                ...
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="editJabatanModalLabel<?= $dj['id_jabatan']; ?>">Change Position</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
                                  </div>
                                  <div class="modal-body">
                                    <div class="form-group">
                                      <label for="nama_jabatan<?= $dj['id_jabatan']; ?>">Position Name</label>
