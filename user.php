<?php 
  ...
  if (isset($_POST['btnTambahUser'])) {
    if (addUser($_POST) > 0) {
      setAlert("User has Been Added", "Successfully Added", "Auccess");
      header("Location: user.php");
    }
  }
?>
                ...
                <form method="post">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="tambahUserModalLabel">Add User</h5>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        <label for="id_jabatan">Position Name</label>
                          ...
                          <div class="modal fade" id="editUserModal<?= $du['id_user']; ?>" tabindex="-1" role="dialog" aria-labelledby="editUserModalLabel<?= $du['id_user']; ?>" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <form method="post">
                                ...
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="tambahUserModalLabel">Change User</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
                                  </div>
                                  <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                      <label for="id_jabatan<?= $du['id_user']; ?>">Position Name</label>
